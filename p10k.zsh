# Generated by Powerlevel10k configuration wizard on 2021-06-08 at 13:57 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=33
  ...
  # typeset -g my_wifi_icon=('\f1eb' 'WiFi' 'WiFi' 'WiFi' 'WiFi')     # <-- change these values
  #
